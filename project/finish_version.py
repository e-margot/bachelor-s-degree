...
class aug_my_CocoDetection(VisionDataset):
    ...
    def _load_image(self, id: int) -> Image.Image:
        ...
        im_aug = torchvision.transforms.RandomInvert(p=0.6)(image)
    ...
    def printf(self, id):
        ...
        im_aug = torchvision.transforms.RandomInvert(p=1)(im)
        im_aug = torchvision.transforms.functional.adjust_sharpness(im_aug, 10)
        # im_aug.show()
...
path2data = "my_FLIR_ADAS_v2/video_rgb_test/new_data"
path2json = "my_FLIR_ADAS_v2/video_rgb_test/ann.json"
